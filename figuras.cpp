...
void CFiguras::skybox(float largo, float altura, float profundidad, GLuint text)  //Funcion creacion cielo
{
	...
	glTexCoord2f(1.0f, 0.333f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.666f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.75f, 0.666f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.75f, 0.333f); glVertex3fv(vertice[1]);
	glEnd();

	glBegin(GL_POLYGON);	//Right
		//glColor3f(0.0,0.0,1.0);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.5f, 0.67f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.75f, 0.67f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.75f, 1.0f); glVertex3fv(vertice[5]);
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.25f, 0.666f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.5f, 0.666f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.5f, 0.333f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.25f, 0.333f); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Left
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.5f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.5f, 0.333f); glVertex3fv(vertice[7]);
	glTexCoord2f(0.75f, 0.333f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.75f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();

	glBegin(GL_POLYGON);  //Bottom
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.5f, 0.333f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.5f, 0.666f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.75f, 0.666f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.75f, 0.333f); glVertex3fv(vertice[3]);
	glEnd();

	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.333f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.25f, 0.333f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.25f, 0.666f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.666f); glVertex3fv(vertice[7]);
	glEnd();
}
...
void CFiguras::vaso()
{
	...
	//glColor3f(1.0, 1.0, 1.0);
	cilindro(1.4, 0.1, 20.0, 0.0);
	torus(1.3, 1.5, 50.0, 50.0);
	...
	glPushMatrix();
	//glColor3f(0.0,1.0,0.0);
	torus(1.5, 2.0, 50.0, 50.0);
	torus(1.8, 2.5, 50.0, 50.0);
	glPopMatrix();
	torus(1.3, 1.5, 50.0, 50.0);
	glTranslatef(0.0, 0.2, 0.0);
	torus(1.3, 1.5, 50.0, 50.0);
...
void CFiguras::prismamesa(float altura, float largo, float profundidad, GLuint text_mesa)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, text_mesa);   // choose the texture to use.
										  //glBindTexture(GL_TEXTURE_2D, texture[filter]);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front
							//glColor3f(0.0,0.0,1.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
...
void CFiguras::cuadro(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.1f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.1f, 0.1f); glVertex3fv(vertice[5]);
	...
	glBegin(GL_POLYGON);  //Left
						  //glColor3f(1.0,1.0,1.0);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.1f, 0.0f); glVertex3fv(vertice[1]);
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.1f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(0.1f, 0.1f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 0.1f); glVertex3fv(vertice[3]);
	glEnd();
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.1f, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.1f, 0.1f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.1f); glVertex3fv(vertice[7]);
	glEnd();
}

void CFiguras::prismamueble(float altura, float largo, float profundidad, GLuint text_mueble)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, text_mueble);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front
							//glColor3f(0.0,0.0,1.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
