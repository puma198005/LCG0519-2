...
public:
	...
	void vaso();
	void prismamesa(float altura, float largo, float profundidad, GLuint text_mesa);//Funcíon creacion prisma
	void cuadro(float altura, float largo, float profundidad, GLuint text);
	void prismamueble(float altura, float largo, float profundidad, GLuint text);
};
